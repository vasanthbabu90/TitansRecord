...
public class ProfessorController 
{
	...
	public String viewProfessor(@ModelAttribute("professor") Professor professor, Model model)
	{
		System.out.println("session student ID "+model.asMap().get("USERID"));
		int professorId = (int) model.asMap().get("USERID");
		
		professor = professorService.getProfessorById(professorId);
		 model.addAttribute("professor", professor);		 
		 
		 return "viewProfessorProfile";		
